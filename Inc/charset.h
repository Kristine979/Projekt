...
ASCII	CHAR	ASCII	CHAR	ASCII	CHAR	ASCII	CHAR	ASCII	CHAR	ASCII	CHAR
 0x20        0x30  0     0x40  @     0x50  P     0x60  `     0x70  p	0x80 right heart (full)
 0x21  !     0x31  1     0x41  A     0x51  Q     0x61  a     0x71  q	0x81 left heart (empty)
 0x22  "     0x32  2     0x42  B     0x52  R     0x62  b     0x72  r	0x82 right heart (empty)
 ...
 0x2F  /     0x3F  ?     0x4F  O     0x5F  _     0x6F  o	 0x7F left heart (full)

Note:
1. The ASCII character 0x20 is "SPACE" or a blank.
2. The ASCII character 0x7F(DEL) is not supported by the matrix below.
3. The ASCII character 0x7F have been replaced by a custom heart
